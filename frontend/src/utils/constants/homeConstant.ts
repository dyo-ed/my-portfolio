...
import heroPiyuWallet from "../../presentation/assets/hero-piyuwallet.png";
import heroBrewrikat from "../../presentation/assets/hero-brewrikat.png";

export const STATS_DEFINITIONS: StatDefinition[] = [
  { id: "01", value: 12, live: false },      // Projects delivered
  { id: "02", value: 2, live: false },      // Research papers published
